...
Usage::
    ...
    from tarok.adapters.ai.factory import get_registry
...
class BotRegistry:
    ...
    def _register_builtins(self) -> None:
        ...
        from tarok.adapters.ai.random_player import RandomPlayer
    ...
    def _discover_stockskis(self) -> None:
        ...
        from tarok.adapters.ai.stockskis_player import RustStockskisPlayer
...
def _make_nn_factory() -> BotFactory:
    ...
    def factory(
        ...
        **kwargs: Any,
        ...
        from tarok.adapters.ai.nn_player import RLAgent

        if checkpoint:
            return RLAgent.from_checkpoint(checkpoint, name=name, device=device)
        return RLAgent(name=name, hidden_size=hidden_size, device=device)
