...
pub fn evaluate_bid(hand: CardSet, highest_so_far: Option<Contract>) -> Option<Contract> {
    let mut taroks = 0u32;
...
pub fn choose_king(hand: CardSet) -> Option<Card> {
...
pub fn choose_talon_group(groups: &[Vec<Card>], called_king: Option<Card>) -> usize {
    let mut best_idx = 0;
...
pub fn choose_discards(hand: CardSet, must_discard: usize, called_king: Option<Card>) -> Vec<Card> {
...
pub fn choose_card(hand: CardSet, state: &GameState, player: u8) -> Card {
